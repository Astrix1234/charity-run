const translations = {
  PL: {
    ...
    thanks:
      'Dziękujemy za chęć zaangażowania się i pomoc w realizacji naszej misji wsparcia osób chorych na białaczki!',
  },
  EN: {
    ...
    thanks:
      'Thank you for your willingness to get involved and help support people with leukemia!',
  },
};
