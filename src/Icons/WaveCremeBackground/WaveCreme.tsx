import scss from './WaveCreme.module.scss';

export const WaveCreme = () => {
  return (
    <svg
      //   width="1440"
      //   height="1268"
    ...
    >
      ...
      <g className={scss.parallax}>
        <use xlinkHref="#top-waveCreme" />
        <use xlinkHref="#bottom-waveCreme" />
        <use xlinkHref="#top-waveCreme" y="15" />
        <use xlinkHref="#bottom-waveCreme" y="15" />
        <use xlinkHref="#top-waveCreme" y="20" />
        <use xlinkHref="#bottom-waveCreme" y="20" />
        <use xlinkHref="#top-waveCreme" y="25" />
        <use xlinkHref="#bottom-waveCreme" y="25" />
      </g>
    </svg>
  );
};
